 ...
 const resetForm=()=>{
  ...
  return (
     ...
     <Grid container spacing={2} direction="row">
      ...
      <TextField label=" Bank Account Number"  type="text" required fullWidth  InputLabelProps={{ shrink: true}}  />
      </Grid>
      <Grid item md={4} xs={12}>
      <TextField  label="IFSC Code" type="text"  required  fullWidth  InputLabelProps={{ shrink: true}}/>
      </Grid >
      <Grid item md={4} xs={12}>
      <TextField  label="Bank Name" type="text"  required  fullWidth  InputLabelProps={{ shrink: true}}/>
      </Grid >
      <Grid item md={4} xs={12} >
